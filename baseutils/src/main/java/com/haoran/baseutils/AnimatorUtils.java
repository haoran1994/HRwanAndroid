...
public class AnimatorUtils {
    ...
    public static void changeLargeViewSize(final View target, final int toWidth, final int toHeight, long duration, Interpolator interpolator) {
        ...
        scaleAnimation.setInterpolator(interpolator != null ? (Interpolator) interpolator : new DecelerateInterpolator());
    ...
    public static void changeViewHeight(final View view, int height, long duration, TimeInterpolator interpolator) {
        ...
        ValueAnimator valueAnimator = null;
            valueAnimator = ValueAnimator.ofInt(lastH, height);
        valueAnimator.setDuration(duration);
        valueAnimator.setInterpolator(interpolator != null ? interpolator : new DecelerateInterpolator());
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
    ...
    public static void doBigDecimalAnim(final TextView target, BigDecimal from, BigDecimal to, final int scaleCount, long duration) {
        ...
        ValueAnimator animator = null;
            animator = ValueAnimator.ofObject(new TypeEvaluator<BigDecimal>() {
                @Override
